...
class AppTheme {
  ...
  static const Color _seedColor = Color(0xFF7C3AED);
  static const Color _darkSeedColor = Color(0xFFC4B5FD);
  ...
  static TextStyle _displayLarge(Color color) =>
      TextStyle(fontSize: 57, fontWeight: FontWeight.w400, height: 1.12, letterSpacing: -0.25, color: color);
  static TextStyle _displayMedium(Color color) =>
      TextStyle(fontSize: 45, fontWeight: FontWeight.w400, height: 1.16, letterSpacing: 0, color: color);
  static TextStyle _displaySmall(Color color) =>
      TextStyle(fontSize: 36, fontWeight: FontWeight.w400, height: 1.22, letterSpacing: 0, color: color);
  static TextStyle _headlineLarge(Color color) =>
      TextStyle(fontSize: 32, fontWeight: FontWeight.w400, height: 1.25, letterSpacing: 0, color: color);
  static TextStyle _headlineMedium(Color color) =>
      TextStyle(fontSize: 28, fontWeight: FontWeight.w500, height: 1.29, letterSpacing: 0, color: color);
  static TextStyle _headlineSmall(Color color) =>
      TextStyle(fontSize: 24, fontWeight: FontWeight.w500, height: 1.33, letterSpacing: 0, color: color);
  static TextStyle _titleLarge(Color color) =>
      TextStyle(fontSize: 22, fontWeight: FontWeight.w500, height: 1.27, letterSpacing: 0, color: color);
  static TextStyle _titleMedium(Color color) =>
      TextStyle(fontSize: 16, fontWeight: FontWeight.w500, height: 1.5, letterSpacing: 0.15, color: color);
  static TextStyle _titleSmall(Color color) =>
      TextStyle(fontSize: 14, fontWeight: FontWeight.w500, height: 1.43, letterSpacing: 0.1, color: color);
  static TextStyle _bodyLarge(Color color) =>
      TextStyle(fontSize: 16, fontWeight: FontWeight.w400, height: 1.5, letterSpacing: 0.15, color: color);
  static TextStyle _bodyMedium(Color color) =>
      TextStyle(fontSize: 14, fontWeight: FontWeight.w400, height: 1.43, letterSpacing: 0.25, color: color);
  static TextStyle _bodySmall(Color color) =>
      TextStyle(fontSize: 12, fontWeight: FontWeight.w400, height: 1.33, letterSpacing: 0.4, color: color);
  static TextStyle _labelLarge(Color color) =>
      TextStyle(fontSize: 14, fontWeight: FontWeight.w500, height: 1.43, letterSpacing: 0.1, color: color);
  static TextStyle _labelMedium(Color color) =>
      TextStyle(fontSize: 12, fontWeight: FontWeight.w500, height: 1.33, letterSpacing: 0.5, color: color);
  static TextStyle _labelSmall(Color color) =>
      TextStyle(fontSize: 11, fontWeight: FontWeight.w500, height: 1.45, letterSpacing: 0.5, color: color);
}
